...
| bamiyanapp/Camp-Stock | 適用済み（[PR #130](https://github.com/bamiyanapp/Camp-Stock/pull/130)） | 適用済み（`frontend/src/App.jsx`の`AppHeader`） | トップページ必須構成は`shared/ui/getAppVersionDefine.js`・`shared/ui/formatBuildTime.js`（issue #338）へ切り替え対応中（[Camp-Stock PR #218](https://github.com/bamiyanapp/Camp-Stock/pull/218)、未マージ） |
